...
$(function () {
  ...
  $(document).ready(function () {
    ...
    var targetDate = new Date(Date.UTC(2024, 7, 10, 0, 0, 0)); // 10th August 2024, 00:00 UTC

    // Convert target date to local time (IST, UTC+5:30)
    var localTargetDate = new Date(targetDate.getTime() - 5.5 * 60 * 60 * 1000); // Adjust for IST offset

    // Initialize countdown
    $("#countdown").countdown({
      until: localTargetDate,
      format: "D",
    });
  });
